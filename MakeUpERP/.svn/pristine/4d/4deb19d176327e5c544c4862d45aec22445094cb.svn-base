...
switch(field.type){
	case 'del':
	html='<a href="javascript:void(0)" class="btnDel '+field.fieldClass+'">删锟斤拷</a>';
	break;
	case 'lookup':
	var suggestFrag='';
	if(field.suggestFields) {
	  ...
	  html='<input readonly="readonly"  type="text" name="'+field.name+'"'+suggestFrag+' lookupPk="'+field.lookupPk+'" style="'+field.size+'" class="'+field.fieldClass+'"/>'
	      +'<a class="btnLook"  '+readonly+' id="'+field.lookupGroup+'Link"  href="'+field.lookupUrl+'&poptarget='+field.lookupGroup+'Link" lookupGroup="'+field.lookupGroup+'" '+suggestFrag+' lookupPk="'+field.lookupPk+'" title="锟斤拷锟揭达拷锟�锟�">锟斤拷锟揭达拷锟�锟�/a>';
	   //html='<input readonly="readonly"  type="text" name="'+field.name+'"'+suggestFrag+' lookupPk="'+field.lookupPk+'" style="'+field.size+'" class="'+field.fieldClass+'"/>'
	   //  +'<a class="btnLook" id="'+field.lookupGroup+'Link"  '+readonly+'  href="'+field.lookupUrl+'&poptarget='+field.lookupGroup+'Link" lookupGroup="'+field.lookupGroup+'" '+suggestFrag+' lookupPk="'+field.lookupPk+'" title="选锟斤拷">选锟斤拷</a>';	   
	break;
	case 'attach':
	//html='<input type="hidden" name="'+field.lookupGroup+'.'+field.lookupPk+suffix+'"/>'+'<input type="text" name="'+field.name+'" '+field.size+' readonly="readonly" class="'+field.fieldClass+'"/>'+'<a class="btnAttach" href="'+field.lookupUrl+'" lookupGroup="'+field.lookupGroup+'" '+suggestFrag+' lookupPk="'+field.lookupPk+'" width="560" height="300" title="锟斤拷锟揭达拷锟�锟�">锟斤拷锟揭达拷锟�锟�/a>';
	...
	break;
	case 'date':
	html='<input '+readonly+' type="text" name="'+field.name+'"  value="'+field.defaultVal+'" class="date '+field.fieldClass+'" format="'+field.patternDate+'" style="'+field.size+'"/>'+'<a class="inputDateButton" href="javascript:void(0)">选锟斤拷</a>';
	break;
		case 'select':
