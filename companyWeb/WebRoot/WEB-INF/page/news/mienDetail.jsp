...
<html>
  ...
  <link rel="stylesheet" href="<%=basePath%>css/newscss/photography.css" />
  <link rel="stylesheet" href="<%=basePath%>css/newscss/photo_effect.css" />
  </head>
  ...
  <div class="hl">
  <div class="mh">
              当前位置 : <a href="<%=basePath%>article/mienList.do?sortId=10&&tab=1">非泊风采</a> > 风采详情
  </div>
  </div>
  <div class="container">
      <div class="cz">
            ...
            <div class="cNav">
              <div class="navPanel">
                 ...
                 <div class="content">
                    <p class="rp">
                      <span class="myscore">风采解读</span>
                     </p>
                    <div class="mcd">
                          <DIV class="MainBg">
                                <DIV class="HS10"></DIV>                                
                                <DIV class="Title">                                
                                <H1>${title}</H1><SPAN class="Counter">（<SPAN class="CounterCurrent">1</SPAN>/${size}）</SPAN></DIV>
