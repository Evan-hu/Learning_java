...
public class AdjustDetailPage extends UnitPage {

	private static final long serialVersionUID = 1L;
	private AdjustFormView formView;
	
	@Override
	public void initController() throws Exception {
		
		 this.formView = new AdjustFormView("innageAdDetail", this.modelMap);
	  ...
	  public void pageLoad(Long id) {
		 try {
		    	 if (this.modelMap.getPageEditMode() == GaConstant.EDITMODE_EDIT) {
		    		 AdjustBiz biz  = new AdjustBiz(this.getUserACL());
