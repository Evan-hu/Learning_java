...
<html>
  ...
  <div class="container">
      <div class="cz">
            ...
            <div class="cNav">
              <div class="navPanel">
                  <div class="navItem" onclick="forward('<%=basePath%>skip/companyInfo.do?code=manager&&tab=2')">总经理致辞</div>
                  <div class="navItem" onclick="forward('<%=basePath%>skip/companyInfo.do?code=about&&tab=2')">关于非泊</div>
                  <div class="navItem curItem" onclick="forward('<%=basePath%>skip/companyInfo.do?code=organiz&&tab=2')">组织架构</div>
                 </div>
              </div>
                 
                 <div class="content">
                    <p class="rp">
                      <span class="myscore">组织架构</span>
                     </p>
