...
<html>
  ...
  <link rel="stylesheet" href="<%=basePath%>css/file_not_found.css" />
  </head>
      ...
      <div class="sec">
          <div class="fileNotFound">
              <div class="fp"></div>
                <div class="rz">
                  <div class="srz">
                      <span class="pr" onclick="err.skipPrev()">
                          <img src="<%=basePath%>images/exceptionimages/prev_1.png" alt="返回上一级"/>
                        </span>
                        <span class="ind" onclick="err.skipIndex()">
                          <img src="<%=basePath%>images/exceptionimages/index_1.png" alt="返回首页" />
                        </span>
                    </div>
                </div>
            </div>
...
<!-- JiaThis Button END -->
<script type="text/javascript" src="<%=basePath%>js/error.js"></script>
</html>