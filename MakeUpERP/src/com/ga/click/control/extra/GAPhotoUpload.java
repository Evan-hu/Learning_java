...
/**
 * 类描述
 * @create_time 2012-3-6 上午11:29:22
 */
public class GAPhotoUpload extends AbstractControl {
  ...
  public GAPhotoUpload(Class callClass,String name,Long id) {
    try {
  ...
  private void initPicList() throws Exception{    
    ...
    boolean fileExist = (new File(FileUploadUtil.getFileRoot() + FilePath.idToPathBase8(commodityId) + commodityId + "_6.jpg")).exists(); //主图
    if (fileExist) {
