...
public class StockAlertListView extends ListView{

	public StockAlertListView(String viewID, ModelMap modelMap) {
	  ...
	  public void initField() throws Exception {
       ...
       dbFields.add(field);
		   ...
		   field = new DbField("库存状态","STATE",GaConstant.DT_INT);
