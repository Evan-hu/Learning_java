...
public class AdDetailPage extends UnitPage {
  ...
  public void initController() throws Exception {
    ...
    public Layout initLayout() {
    	...
    	formLayout.mergeCellField("auto", this.modelMap.getPageEditMode() ==
    			GaConstant.EDITMODE_NEW ? 2 : 4, 0, 1, "NOTE");
    	formLayout.mergeCellField("auto", this.modelMap.getPageEditMode() == 
    			GaConstant.EDITMODE_NEW ? 3 : 5, 0, 1, "CONTENT");
    ...
    public void pageLoad(Long adId) {
  	  try {   
  	    if (this.modelMap.getPageEditMode() == GaConstant.EDITMODE_EDIT) {
  	    	  this.adForm.getFieldByCode("STORE_NAME").setPopSelect("STORESELECT",
  	    			  "STORE_NAME",true,"", "", 0,0);
