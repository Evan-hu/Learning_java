...
import com.ga.click.page.GaPage;
...
public class ClickServlet extends HttpServlet {
    ...
    protected void renderTemplate(Page page) throws Exception {
        ...
        if (page instanceof GaPage && ((GaPage)page).getLayout() != null) {
          //直接输出布局文件信息
          Map<String,Object> rtnInfo = new HashMap<String,Object>();
          rtnInfo.put("page",((GaPage)page).getLayout());
          configService.getTemplateService().renderTemplate("/clicktemplate/page.htm", rtnInfo, writer);
        } else if (page instanceof UnitPage && ((UnitPage)page).getLayout() != null) {
          //直接输出布局文件信息
          Map<String,Object> rtnInfo = new HashMap<String,Object>();
          rtnInfo.put("page",((UnitPage)page).getLayout());
          configService.getTemplateService().renderTemplate("/clicktemplate/page.htm", rtnInfo, writer);
        }else {
        ...
        try {
            ...
            if (exception instanceof BizException) {
             ...
             if (bizException != null) {               
               ...
               writer = getPrintWriter(response);
               response.setStatus(HttpServletResponse.SC_EXPECTATION_FAILED);
               returnJson = "{\"statusCode\":\"300\", \"message\":\"系统发生异常-"+exception.getMessage()+"\"}";
             }
